...
class AgentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agente" do
    assert_difference("Agente.count") do
      post agentes_url, params: { agente: { nombre: @agente.nombre, user_id: @agente.user_id } }, as: :json
    end
  ...
  test "should update agente" do
    patch agente_url(@agente), params: { agente: { nombre: @agente.nombre, user_id: @agente.user_id } }, as: :json
    assert_response :success
  end
